...
{
    public class StoryBookmarks1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public StoryBookmarks1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
            ...
            var adminActions = new List<(string Name, string Action, string Controller)>
    {
        ...
        ("عرض الاشارات المرجعية ", "Index", "StoryBookmarks1")
    };
        ...
        // POST: StoryBookmarks1/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("Id,UserPalId,QusId,LastImageIndex")] StoryBookmark storyBookmark)
        {
            ...
            ViewData["QusId"] = new SelectList(_context.Qusis, "Id", "Title", storyBookmark.QusId);
            ViewData["UserPalId"] = new SelectList(_context.UsersPal, "Id", "Email", storyBookmark.UserPalId);
            return View(storyBookmark);
        }

        // GET: StoryBookmarks1/Edit/5
        ...
        // POST: StoryBookmarks1/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserPalId,QusId,LastImageIndex")] StoryBookmark storyBookmark)
        {
