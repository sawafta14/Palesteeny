...
{
    public class Drawings1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public Drawings1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
            ...
            var adminActions = new List<(string Name, string Action, string Controller)>
    {
        ...
        ("إضافةادوات جديدة", "Create", "Drawings1"),
        ("التعديل على بيانات الرسام ", "Index", "Drawings1"),
        ("حذف رسمة من المعرض", "Index", "Drawings1"),
        ("عرض بيانات الرسام", "Index", "Drawings1")
    };
