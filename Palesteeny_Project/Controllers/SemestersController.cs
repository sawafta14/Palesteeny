...
namespace Palesteeny_Project.Controllers
{
            ...
            var adminActions = new List<(string Name, string Action, string Controller)>
    {
        ...
        public async Task<IActionResult> Create([Bind("SemesterId,GradeName,SemesterName,RegistrationDate")] Semester semester)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SemesterId,GradeName,SemesterName,RegistrationDate")] Semester semester)
        {
