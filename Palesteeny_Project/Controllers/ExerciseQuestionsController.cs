...
namespace Palesteeny_Project.Controllers
{
            ...
            var adminActions = new List<(string Name, string Action, string Controller)>
    {
        ...
        {
            var applicationDbContext = _context.ExerciseQuestions.Include(e => e.Lesson);
        ...
        public async Task<IActionResult> Create([Bind("ExerciseQuestionId,Question,Type,ImageUrl,questionOverlay,Answer,UserAnswer,IsCorrect,LessonId")] ExerciseQuestion exerciseQuestion)
        {
            ...
            ViewData["LessonId"] = new SelectList(_context.Lessons, "LessonId", "LessonId", exerciseQuestion.LessonId);
            return View(exerciseQuestion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExerciseQuestionId,Question,Type,ImageUrl,questionOverlay,Answer,UserAnswer,IsCorrect,LessonId")] ExerciseQuestion exerciseQuestion)
        {
