...
{
    public class UserLessons1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public UserLessons1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
            ...
            var adminActions = new List<(string Name, string Action, string Controller)>
    {
        ...
        ("حذف تقدم طالب", "Index", "UserLessons1"),
        ("عرض بيانات تقدم الطلاب", "Index", "UserLessons1")
    };
