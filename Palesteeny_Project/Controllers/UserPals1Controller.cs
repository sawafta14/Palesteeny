...
{
    public class UserPals1Controller : Controller
    {
        private readonly ApplicationDbContext _context;

        public UserPals1Controller(ApplicationDbContext context)
        {
            _context = context;
        }
